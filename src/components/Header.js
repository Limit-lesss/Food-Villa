    ...
    <Link to={"/Food-Villa"}>
      <div className="flex items-center">
        <img
          ...
          alt="food villa"
          className="w-36 h-14 ml-16  scale-125 sm:max-lg:scale-100 sm:max-lg:ml-2"
          data-testid="logo"
        />
...
const Header = () => {
  ...
  return (
    ...
    fixed w-full top-0 z-40 sm:max-lg:hidden">
        <Title />
        <div className="w-1/2">
      ...
      <div
        className="sm:max-lg:visible lg:hidden flex items-center justify-between bg-rose-100 dark:bg-slate-700 py-1 
    fixed w-full top-0 z-40 pr-6">
        <Title />
        <div className="flex items-center w-24 justify-around">
          <img
            ...
            alt="discount--v1"
          />
          <p className="font-semibold text-gray-600 text-lg">Offer</p>
        </div>
      </div>
    </>
  );
